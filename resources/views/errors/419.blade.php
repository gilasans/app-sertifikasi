...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{asset('auth')}}/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <p class="mb-4 mx-2">Oops! 😖 Sorry, your Session Has Expired.</p>
        ...
        <div class="mt-3">
          <img
            src="{{asset('auth')}}/assets/img/illustrations/undraw.png"
