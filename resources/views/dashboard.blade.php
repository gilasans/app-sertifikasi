...
<head>
    <meta charset="utf-8">
    <title>PeTIK - Pesantren teknologi informasi & komunikasi</title>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('dist') }}/img/1.jpeg" alt="Image" style="height: 680px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Inovative Teknologi Digital</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('dist') }}/img/3.jpg" alt="Image" style="height: 680px">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Creative & Innovative</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Creative & Innovative Teknologi Digital
                                Course</h1>
                            <a href="{{route('course.create')}}" 
                               class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                                Daftar Sekarang
                ...
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4"
                        ...
                        <div class="ps-4">
                            ...
                            <h1 class="text-white mb-0" data-toggle="counter-up">1532</h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-lg-7">  
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">The best IT training for 10 years
                        </h1>
                    </div>
                    <p class="mb-4">Pesantren Teknologi Informasi dan Komunikasi (PeTIK) bermula dari keberadaan Lembaga Amil Zakat Infaq dan Shodaqoh PT PLN (Persero) Kantor Pusat (LAZIS PT PLN (Persero) Kantor Pusat) yang dibentuk berdasarkan Keputusan Direksi Nomor 132.K/DIR/2006 Tanggal 11 September 2006 untuk mengelola dana zakat, infaq/ shodaqoh pegawai PLN Pusat.

                        Berawal dari asa yang terpendam, dalam namun berakar sangat kuat. Akar yang berfundamen dan berpotensi untuk melahirkan spirit besar dan mulia. Merancang peradaban (baca, menghargai tinggi nilai-nilai kemanusiaan). </p>
                    ...
                    <a href="" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Daftar Sekarang</a>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" id="service" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">the characters we apply
                </h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <p class="m-0">Meningkatkan kebahagiaan dan kesejahteraan mental Penelitian menunjukkan bahwa orang yang religius cenderung lebih bahagia, lebih terarah dalam hidup, dan lebih mampu mengatasi stres dan kesulitan.                        </p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <p class="m-0"> Meningkatkan Kepercayaan Diri: Integritas membantu Anda untuk lebih percaya diri dalam bertindak dan mengambil keputusan. Ketika Anda selalu bertindak sesuai dengan nilai-nilai dan prinsip yang dipegang teguh, Anda akan merasa lebih tenang dan yakin akan pilihan Anda.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <p class="m-0">Dengan kerjasama, banyak ide dan solusi dapat muncul, sehingga memicu inovasi dan meningkatkan produktivitas.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <p class="m-0">Meningkatkan rasa percaya diri: Ketika Anda mampu menyelesaikan tugas dan mencapai tujuan secara mandiri, rasa percaya diri Anda akan meningkat. Anda akan merasa lebih yakin dengan kemampuan Anda dan lebih mampu menghadapi tantangan</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <p class="m-0">Meningkatkan Keteraturan: Disiplin membantu Anda mengatur waktu dan tugas dengan baik, sehingga Anda dapat menyelesaikan pekerjaan dengan lebih efisien dan memiliki waktu luang untuk hal-hal yang Anda sukai.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <p class="m-0">Meningkatkan kepercayaan diri: Ketika Anda berani menghadapi rasa takut dan mengambil risiko, Anda akan merasa lebih percaya diri pada kemampuan diri sendiri.</p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
    ...
    <div class="container py-5">
        ...
        <div class="row g-5">
            <div class="col-lg wow slideInUp" data-wow-delay="0.2s">
                <div class="team-item bg-light rounded overflow-hidden">
                    <div class="team-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset('dist') }}/img/atan.png" alt="" style="height: 300px">
                    ...
                    <div class="text-center py-4">
                        <h4 class="text-primary">Kukuh akhyar patani</h4>
            ...
            <div class="col-lg wow slideInUp" data-wow-delay="0.4s">
                <div class="team-item bg-light rounded overflow-hidden">
                    <div class="team-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ asset('dist') }}/img/epul.jpg" alt="" style="height: 300px">
                        <div class="team-social">
                            <a class="btn btn-lg btn-primary btn-lg-square rounded"
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">M Saefulloh</h4>
                ...
                <div class="col-lg wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('dist') }}/img/kahfi.png" alt="" style="height: 300px">
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded"
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">M qahfi al ghifari</h4>
                ...
                <div class="col-lg wow slideInUp" data-wow-delay="0.8s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('dist') }}/img/haikal.png" alt="" style="height: 300px">
                            <div class="team-social">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded"
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Haikal</h4>
                ...
                <div class="col-lg wow slideInUp" data-wow-delay="1s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('dist') }}/img/lutaf.png" alt="" style="height: 300px">
                            <div class="team-social">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary"> M Lutfi </h4>
        ...
        <div class="container py-5 mb-5">
            <div class="bg-white">
                <div class="owl-carousel vendor-carousel">
                    <img src="{{ asset('dist') }}/img/vendor-1.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-2.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-3.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-4.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-5.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-6.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-7.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-8.jpg" alt="">
                    <img src="{{ asset('dist') }}/img/vendor-9.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div
                        ...
                        <p class="mt-3 mb-4">Berawal dari asa yang terpendam, dalam namun berakar sangat kuat. Akar yang berfundamen dan berpotensi untuk melahirkan spirit besar dan mulia. Merancang peradaban (baca, menghargai tinggi nilai-nilai kemanusiaan).                        </p>
                        <form action="">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">
                                <h3 class="text-light mb-0">PeTIK</h3>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                <a class="text-light mb-2" href="https://github.com/bgpaten/PeTIK" target="blank"><i
