                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="{{route('course.update',$data->id)}}" method="post">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <input type="number" value="{{$data->no_telpon}}" class="form-control border-0 bg-light px-4 @error('no_telpon') is-invalid @enderror" placeholder="Masukkan Nomer Telpon" name="no_telpon" style="height: 55px;">
                                @error('no_telpon')
                                    <p class="text-danger">{{ $message }}</p>
                                 @enderror
                            </div>
                            <div class="col-md-6">
                                <input type="text" value="{{$data->asal_sekolah}}" class="form-control border-0 bg-light px-4 @error('asal_sekolah') is-invalid @enderror" placeholder="Masukkan asal sekolah" name="asal_sekolah" style="height: 55px;">
                                @error('asal sekolah')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <input type="text" value="{{$data->jurusan}}" class="form-control border-0 bg-light px-4 @error('jurusan') is-invalid @enderror" placeholder="Masukkan Jurusan" name="jurusan" style="height: 55px;">
                                @error('jurusan')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <input type="date" value="{{$data->tgl_lahir}}" class="form-control border-0 bg-light px-4 @error('tgl_lahir') is-invalid @enderror" placeholder="Pilih tanggal lahir" name="tgl_lahir" style="height: 55px;">
                                @error('tgl_lahir')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-md-12">
                                <select id="kursus" class="form-select border-0 bg-light px-4 @error('kursus') is-invalid @enderror" name="kursus" style="height: 55px;">
                                    ...
                                    <option value="{{$kurs->id}}"@selected($data->kursus_id == $kurs->id)>{{$kurs->nama_kursus}}</option>
                                    @endforeach
                                </select>
                                @error('kursus')
                                    <p class="text-danger">{{ $message }}</p>
                            ...
                            <div class="col-12">
                                <textarea  class="form-control border-0 bg-light px-4 py-3 @error('alamat') is-invalid @enderror" rows="4" name="alamat" placeholder="Masukan alamat">{{$data->alamat}}</textarea>
                                @error('alamat')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
